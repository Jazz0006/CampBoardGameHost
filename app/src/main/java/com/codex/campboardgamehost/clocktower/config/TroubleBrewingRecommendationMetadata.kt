...
internal object TroubleBrewingRecommendationMetadata {
    ...
    private val roles: Map<RoleId, RoleRecommendationMetadata> = mapOf(
        "Washerwoman" to RoleRecommendationMetadata(2, 3, 2, 1),
        "Librarian" to RoleRecommendationMetadata(2, 3, 2, 1),
        "Investigator" to RoleRecommendationMetadata(3, 4, 2, 1),
        "Chef" to RoleRecommendationMetadata(1, 2, 1, 2),
        "Empath" to RoleRecommendationMetadata(3, 4, 3, 0),
        "Fortune Teller" to RoleRecommendationMetadata(5, 5, 4, -2),
        "Undertaker" to RoleRecommendationMetadata(4, 4, 3, 0),
        "Monk" to RoleRecommendationMetadata(4, 3, 2, 1),
        "Ravenkeeper" to RoleRecommendationMetadata(4, 3, 3, 1),
        "Virgin" to RoleRecommendationMetadata(3, 4, 3, 5),
        "Slayer" to RoleRecommendationMetadata(4, 4, 2, 1),
        "Soldier" to RoleRecommendationMetadata(2, 2, 1, 3),
        "Mayor" to RoleRecommendationMetadata(4, 4, 3, 1),
        "Butler" to RoleRecommendationMetadata(1, 2, 1, 3),
        // Avoid stacking the Fortune Teller's persistent false positive on the already unreliable Drunk.
        "Drunk" to RoleRecommendationMetadata(1, 3, 4, -3),
        "Recluse" to RoleRecommendationMetadata(2, 4, 3, 3),
        "Saint" to RoleRecommendationMetadata(4, 5, 3, 4),
