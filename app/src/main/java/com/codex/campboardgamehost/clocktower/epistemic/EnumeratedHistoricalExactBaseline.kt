 ...
 * merged under GLOBAL_V1 ordering and projected through [PlayerHistoricalTimeline]. Storyteller-only
 * Poison, Protect, Attack, and RoleChange facts may exist in persisted history, but their payloads
 * and occurrence points are omitted by that projection. Hidden mechanics are regenerated from rules
 * and each possible world's current state; Storyteller-selected hidden targets never become player
 * knowledge.
 *
