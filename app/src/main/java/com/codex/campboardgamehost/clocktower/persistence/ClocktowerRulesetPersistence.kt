 ...
 * such as Scarlet Woman or Imp succession. It is current runtime evidence for reproducing the
 * existing A3/A4 correctness identity; it is deliberately separate from normalized script content
 * identity.
 */
