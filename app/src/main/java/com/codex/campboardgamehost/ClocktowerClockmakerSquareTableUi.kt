...
/**
 * Clockmaker's existing information domain remains authoritative. This presentation adapter keeps
 * the shown number opaque and never parses presentation text back into semantic game state.
 */
