 ...
 *
 * Demon bluffs were not shown in the primary recording segment available for reconstruction and are
 * intentionally absent here. They do not participate in the production legality domains exercised
 * by the Washerwoman, Chef, Red Herring, or fixed-target Fortune Teller observations below.
 */
