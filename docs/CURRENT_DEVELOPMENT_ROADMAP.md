...
- **Current C4 checkpoint:** CR-A / CR-B / CR-C remain COMPLETE. C4 / SDE-3D2 T0-A typed truth/credibility owner, T0-B Red-Herring setup-precommit adapter, exact truth-danger source projection, Evin E2 semantic regression, V1 invariance, DecisionTrace schema-v2 typed persistence, bounded schema-v1 read migration, and deterministic replay recomputation are COMPLETE. Latest validation-only Draft PR #158 exact head `1299fba4fe9f884e468f85639e56ec0b0926794b` is GREEN with CI #3470 + R2 #3223, including Android FULL, ASP contracts, Real Clingo and final CI gate. The schema/invariance net six-file slice was persisted as formal-branch commit `5e563b377df8988cca805d8e34aef7e5823e209f`. V1 rejection/survivor/`SEEDED_HASH_V1` semantics and frozen evidence checkpoint remain unchanged; no placeholder V2 is authorized. Next executable work is a bounded production fanout / integration-closure audit before any wider C4 wiring.

Upstream development branch: `sde-3c-decision-trace-shadow-replay` (local continuation branch above).

Latest formal integration code checkpoint: `5e563b377df8988cca805d8e34aef7e5823e209f` — one six-file schema/invariance commit on top of the earlier C4 implementation checkpoint `d39b336145b19ba29690a5b2dd14ed38273a6cc5`. Acceptance evidence belongs to validation-only Draft PR #158 exact head `1299fba4fe9f884e468f85639e56ec0b0926794b`: CI #3470 SUCCESS and R2 #3223 SUCCESS. Earlier accepted checkpoints remain initial C4 validation `f181780b` (CI #3468 / R2 #3221), CR-A/B/C validation `4245ddb8` (CI #3459 / R2 #3212), SDE-3D1 `f562887c` (CI #3446 / R2 #3201) and SDE-3C5 `db7d5575`. Documentation-only synchronization commits may advance the formal branch; always query live refs.
