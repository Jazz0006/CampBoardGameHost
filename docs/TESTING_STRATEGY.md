...
| `Sde2D5FB4FSilverGeneralizationExperiment` | dedicated ClockTracker whole-bundle topology workload; measured independently by its workflow | replays the executable ct-01 SILVER fixture through production-owned legality/topology surfaces and emits bounded GOLD-hypothesis generalization evidence | explicit T3 evidence harness, dedicated task/workflow only | D5F-B4F bounded SILVER generalization |
